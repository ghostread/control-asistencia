<div class="form-group row">
    ...
    <div class="col-md-9">
    <input type="text" name="nombre" id="nombre" class="form-control" autocomplete="off" value="{{$materia->materia}}" placeholder="Nombre de la materia">   
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
    <select  type="text" name="facultad" id="facultad" class="form-control" value="{{$materia->facultad}}" placeholder="Ingrese la facultad"  >

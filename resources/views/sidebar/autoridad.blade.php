      ...
      <ul class="nav">
        <li class="nav-item">
          <a class="nav-link active" href="#">
            <i class="nav-icon fa fa-user"></i> Autoridad :
        ...
        <li class="nav-item">
        <a class="nav-link" href="{{url('personalacademico')}}">
            <i class="nav-icon fa fa-users"></i> Personal Academico</a>
        </li>

        <li class="nav-item">
        <a class="nav-link" href="{{url('asistencias')}}">
            <i class="nav-icon fa fa-pencil"></i> Asistencias</a>
        </li>
